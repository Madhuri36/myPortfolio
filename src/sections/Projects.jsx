...
const Projects = () => {
  ...
  return (
    <section className="relative pb-10 bg-[#010102]">
      {/* 1. CUSTOM CURSOR */}
      <motion.div
        style={{
          left: cursorX,
...
const ProjectCard = ({ project, onImageEnter, onImageLeave, isImageHovered }) => {
  return (
    <motion.div 
      ...
      /* REMOVED ROUNDED CORNERS: Sharp square card with solid white border */
    ...
    >
      <a 
        ...
        className={`relative w-full aspect-[16/10] overflow-hidden block ${isImageHovered ? 'cursor-none' : 'cursor-default'}`}
